...
%
\author{David Osumi-Sutherland$^1*$}  % TBA
...
\bibliography{Roche_swat4ls_2015.bib} % Bibliography file (usually '*.bib' )
...
\begin{figure}
\centering
\includegraphics[width=160mm]{auto_only.png}
...
\begin{figure}
\centering
\includegraphics[width=160mm]{amigo.png}
...
% \section*{Tables}
%    \subsection*{Table 1: Example mapping table.}
%      \mbox{
%       \begin{tabular} { c c c c c c c } \textbf{name}&\textbf{ID}&\textbf{manual}&\textbf{auto}&\textbf{checked}&\textbf{blacklisted}&\textbf{is\_obsolete} \\\hline
...
%  \subsection*{Table 3: Common mapping queries}
%       \par
%       \mbox{
%         \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
% \textbf{RCV term name pattern}&\textbf{Most common mapping query (relation + target class ontology)}&\textbf{No. cases different mapping query used} \\\hline
% chemical (e.g. cannabinoid)&participant_OR_reg_participant + ChEBI (used 22 times)&7 \\\hline
% chemical metabolism (e.g. &Equivalence + GO (used 34 times)&6 \\\hline
% cell type (e.g. T cell)&parts_participation_location + CL (covers parts, participant processes and processes occurring in cell type. used 30 times)&1 \\\hline
% X development (e.g. bone development)&is_a_OR_part_of_OR_regulates + GO (used 41 times)&6 \\\hline
% X pathway/signalling (e.g. BMP signalling)&is_a_OR_part_of_OR_regulates + GO (used 21 times)&6 \\\hline
%         \end{tabular}
%         }
